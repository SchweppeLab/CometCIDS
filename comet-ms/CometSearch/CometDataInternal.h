...
struct SpectrumInfoInternal
{
   ...
   double dRTime;
   double minMz;                      // The lowest m/z observed in the spectrum
   double maxMz;                      // The highest m/z in the spectrum
...
struct IonInfo
{
   ...
   std::vector<int> ammoniaLosses;
   std::vector<int> waterLosses;
   ...
   IonInfo& operator=(IonInfo& a)
   {
      ...
      ammoniaLosses = a.ammoniaLosses;
      waterLosses = a.waterLosses;
...
struct Query
{
   ...
   Query()
   {
      ...
      _spectrumInfoInternal.maxMz = 0.0;
      _spectrumInfoInternal.minMz = 0.0;

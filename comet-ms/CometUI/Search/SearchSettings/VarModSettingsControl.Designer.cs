namespace CometUI.Search.SearchSettings
{
    partial class VarModSettingsControl
    {
        ...
        private void InitializeComponent()
        {
         ...
         this.label6.Text = "Maximum # of allowed variable mods in each peptide:";
         // 
         ...
         this.requireVarModCheckBox.Size = new System.Drawing.Size(229, 17);
         this.requireVarModCheckBox.TabIndex = 38;
         this.requireVarModCheckBox.Text = "Require all peptides contain a variable mod";
